...
const CLOUDLET_DISK_RATE_CZK = parseFloat(process.env.IaaS_PAAS_DISK_RATE_CZK) || 2.4 // cena / GB / měsíc
...
function summarize(nodes, cm = DEFAULT_COMMITMENT, remoteBackupGB = null) {
  ...
  return {
    ...
    cloudletDiskRateCZK: CLOUDLET_DISK_RATE_CZK,
...
function paasConfig() {
  return {
    ...
    diskRateCzk: CLOUDLET_DISK_RATE_CZK,
